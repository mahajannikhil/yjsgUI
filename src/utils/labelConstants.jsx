...
export const MOBILE_NUMBER_LABEL = 'मोबाइल नं';
...
export const ID_CARD_PRINT_STATUS_FOR_SELECTED_STUDENTS_LABEL = 'कृपया दिए गए IDs को  कार्ड प्रिंट के लिए चयन करें!';
