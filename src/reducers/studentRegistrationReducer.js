...
const allStudentsDataReducerInitialState = {
  ...
  visibleColumnConfig: {
    ...
    classAttended2018: true,
    classAttended2019: true,
    classRoomNo2016: true,
    classRoomNo2017: true,
    classRoomNo2018: true,
    classRoomNo2019: true,
    attendance2016: true,
    attendance2017: true,
    attendance2018: true,
    attendance2019: true,
  ...
  switch (action.type) {
    ...
    case 'UPLOAD_OPT_IN_FILE_SUCCESS':
      return {
        ...
        isIdUnavailable: action.idNotExist,
      };
 ...
 * @return {null}
 */
export const isIdUnavailable = state => state.allStudentsDataReducer.isIdUnavailable;